	...
	<div class="container">
		<div class="card hoverable">
			<div class="card-content">
				...
				<p class="text" style="font-size: 110%">
					Students' Alumni Cell has come up with the Working Scholars program where students get the opportunity to learn new skills or teach a skill of their choice. Under this program, you can learn anything from photography to machine learning or get some help in any subject of your coursework. Grab this unique oppprtunity to learn something unique and useful.
				</p>
			</div>
		</div>
	</div>
				...
				<div class="col l6 m6 s12">
					<div class="card hoverable">
						...
						<div class="card-content" style="height: 317px">
							<center><span class="card-title">APPLY FOR A JOB</span></center>
				...
				<div class="col l6 m6 s12">
					<div class="card hoverable">
						...
						<div class="card-content" style="height: 317px">
							...
							<p class="text" style="font-size: 100%; padding-bottom: 12px;">Alumni of IIT Kharagpur can now offer freelancing jobs to the alma mater. To post a job, login to your account. And if you have not one, register to do so!
							</p>
